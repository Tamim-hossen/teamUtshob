...
function page() {
    ...
    return (
        <div className='w-100vw flex flex-col justify-center items-center'>
            ...
            >
                <motion.div
                    className="w-[95%]  flex flex-col md:flex-row justify-center items-end  gap-20"
                    variants={textVariants}
                >


                    <div className='flex flex-col items-start'>
                        <h1 className={`${kosthipathor.className} text-3xl md:text-6xl   w-full text-center md:text-start `}>
                            {event.name}
                        </h1>
                        <h3 className={`${kosthipathor.className} text-lg md:text-2xl py-5 w-full leading-relaxed text-center md:text-start`}>
                            {event.description}
                        </h3>
                    ...
                    >
                        <Image
                            ...
                            className="lg:w-full lg:h-full w-full h-full rounded-xl shadow-lg object-cover"
                        />
                    </motion.div>
