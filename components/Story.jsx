    ...
    <div className='max-w-[100vw] flex flex-col justify-center items-center p-4'>
        <div className='w-[100vw] flex flex-col justify-center items-center'>
            <div className='w-[80%] flex flex-col justify-center items-center'>
                <h1 className={`${kosthipathor.className} text-5xl md:text-7xl pt-20`}>টিম উৎসব</h1>
            </div>
            <p className={`${kosthipathor.className} text-xl md:text-2xl text-center py-5 w-[80%]`}>আমরা বাংলাদেশ কৃষি বিশ্ববিদ্যালয়, ময়মনসিংহের একটি সাংস্কৃতিক ক্লাব। আমাদের মূল উদ্দেশ্য হলো বিশ্ববিদ্যালয় ক্যাম্পাসে বাংলা সংস্কৃতিকে আপন করে ধরে রাখা এবং সেই আবহকে কাছ থেকে অনুভব করা।
